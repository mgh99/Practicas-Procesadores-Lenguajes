...
public class PalabrasReservadas {
	...
	private Hashtable<String, String> componentesLexicos = new Hashtable<String, String>();
	...
	private static void leeComponentesLexicos(Hashtable<String, String> componentesLexicos,
			String ficheroComponentesLexicos) {
